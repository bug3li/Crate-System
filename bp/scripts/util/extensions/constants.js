...
export const custom_content = {
    'ghost:booster_key': {
		 texture: 'textures/items/boosterkey',
		 type: 'item'
	},
	'ghost:pvp_key': {
		 texture: 'textures/items/pvpkey',
		 type: 'item'
	},
    'ghost:spawner_key': {
		 texture: 'textures/items/spawnerkey',
		 type: 'item'
	},
    'ghost:rare_key': {
		 texture: 'textures/items/rarekey',
		 type: 'item'
	},
    'ghost:ultra_key': {
		 texture: 'textures/items/ultrakey',
		 type: 'item'
	},
    'npc:adjust_height_medium': {
		 texture: 'npc:adjust_height_medium',
		 type: 'item'
	},
    'npc:adjust_height_tall': {
		 texture: 'npc:adjust_height_tall',
		 type: 'item'
	},
    'npc:adjust_height_small': {
		 texture: 'npc:adjust_height_small',
		 type: 'item'
	},
    'npc:adjust_height_xtra_small': {
		 texture: 'npc:adjust_height_xtra_small',
		 type: 'item'
	},
};
